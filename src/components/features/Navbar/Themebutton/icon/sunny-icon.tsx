...
export const SunnyIcon = component$(() => {
            ...
            <g stroke="currentColor" stroke-linecap="round" stroke-width="2">
                ...
                >
                    <animate
                        ...
                        begin="sunny-filled-entrypoint.begin"
                        dur="0.2s"
                        values="34;0"
                    />
                    <animate
                        ...
                        begin="sunny-filled-entrypoint.begin+0.45s"
                        dur="0.25s"
                        values="0;1"
                    />
                </path>
                <g fill="none" stroke-dasharray="2" stroke-dashoffset="2">
                    <path d="M0 0">
                        <animate
                            fill="freeze"
                            attributeName="d"
                            begin="sunny-filled-entrypoint.begin+0.25s"
                            dur="0.1s"
                    ...
                    <path d="M0 0">
                        <animate
                            fill="freeze"
                            attributeName="d"
                            begin="sunny-filled-entrypoint.begin+0.35s"
                            dur="0.1s"
